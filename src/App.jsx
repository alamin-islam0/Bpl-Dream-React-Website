...
function App() {
  ...
  return (
    <>
      ...
      <div className="flex flex-col sm:flex-row gap-4 sm:gap-0 sm:justify-between sm:items-center max-w-[1200px] mx-auto bg-white pt-8 px-4">
        ...
        <div className="">
          <button onClick={()=> setToggle(true)}
            className={`p-3 border-r-0 border-1 rounded-l-2xl border-[#13131320] ${toggle === true?"bg-[#E7FE29]": ""} text-black w-full sm:w-auto`}
            type="button"
          >
            Available
          </button>
          <button onClick={()=> setToggle(false)}
            className={`p-3 border-1 border-l-0 rounded-r-2xl border-[#13131320] ${toggle === false?"bg-[#E7FE29]":""} text-black w-full sm:w-auto`}
            type="button"
          >
